            ...
            {step === 3 && (
              <form>
                <div className="mb-4">
                  ...
                  <input type="text" name="tools_used" value={toolsUsed || ''} onChange={(e)=> setToolsUsed(e.target.value)} className="mt-1 block w-full p-2 border border-gray-300 rounded-md" />
                </div>
                <div className="mb-4">
