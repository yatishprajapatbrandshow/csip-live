                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div className="bg-rose-100 space-y-2 transition-transform duration-200 ease-in transform hover:translate-y-0.5">
                            ...
                            <div className='p-4 pt-2 grid grid-cols-2 gap-4'>
                                {!collegeData ? <button onClick={() => router.push('/AllCurriculum')} className="text-sm hardShadow flex justify-center items-center text-gray-700 bg-white/30 p-2 border border-rose-300 ">Choose Curriculum</button> :
                        ...
                        <div className="bg-[#dfccfa] p-4 col-span-3 grid grid-cols-2 md:grid-cols-4 gap-4  transition-transform duration-200 ease-in transform hover:translate-y-0.5">
                            {stats.map((stat, index) => (
                                <div
                                    ...
                                    className={`flex bg-purple-100 items-center hardShadow2 gap-2 border border-purple-300 p-1 transition-transform duration-200 ease-in transform hover:translate-y-0.5 ${stat.link ? 'cursor-pointer' : ''
                                        }`}
                                >
