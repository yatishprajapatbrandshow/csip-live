                    ...
                    <div className="absolute -bottom-4 left-2 bg-white rounded-lg shadow-lg">
                        ...
                        {activity.companyLogo ?
                            <img
                                ...
                                className="object-contain mx-auto w-24  h-14 p-2"
                            />
                            :
                            <Image
                                src={DefaultLogo}
                ...
                <div className="flex justify-between h-11 border-t border-gray-300">
                    ...
                    </button>
                    {
                        activity?.paymentStatus === "pending" && activity?.status === 'Active' ? (
                            <button className="bg-white bg-pattern bg-no-repeat bg-[length:100px_100px] bg-right w-full text-gray-800 text-sm transition-colors"
                            ...
                            <button className="bg-white bg-pattern bg-no-repeat bg-[length:100px_100px] bg-right w-full text-gray-800 text-sm transition-colors" onClick={handlePopUp}>
                                Apply Now
                            </button>
                        )
                    }
