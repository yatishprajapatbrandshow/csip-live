            ...
            <div className="bg-white py-10 px-10 max-sm:px-5 rounded-xl">
              ...
              ${isChecked ? "bg-[#6045E2] border-[#6045E2]" : ""}`}
                        ...
                        <span className="text-[.75rem] text-gray-500 inline-block mt-2">
                            <Link href="/signup" className="text-sm text-[#6045E2] font-medium hover:text-[#8a74fc] duration-150">
                                Sign Up
                            </Link>
                    ...
                    isEmailLogin && (
                        <div>
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="flex items-center w-full justify-between max-sm:flex-col max-sm:items-start max-sm:gap-5">
                                    <div className="flex gap-2 items-center">
                                        <input
                                            type="checkbox"
                                            id="custom-checkbox"
                                    ...
                                    <div>
                                        <a onClick={handleFormSwitch} className="text-sm cursor-pointer text-gray-500">
                                            Forgot Password?
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div className="text-[.75rem] text-gray-500  mt-5">
                                <Link href="/signup" className="text-sm text-[#6045E2] font-medium hover:text-[#8a74fc] duration-150 ">
                                    Sign Up
                                </Link>
                                ,  If you have no account.
