...
function Login() {
    ...
    // State to manage form view
    const [isEmailLogin, setIsEmailLogin] = useState(false);
    // State to manage OTP field visibility
    const [isOtpSent, setIsOtpSent] = useState(false);
    // State to manage OTP success
    ...
    const handleSendOtp = () => {
        ...
        }, 2000); // Simulate a delay for sending the OTP
    };
    return (
                ...
                isEmailLogin && (<div>
                    ...
                    <div className='flex items-center w-full justify-between'>
                        <div className="flex gap-2 items-center" >
                            ...
                            {/* Checkbox Label */}
                            <span className="text-gray-700 cursor-pointer" onClick={handleCheckboxChange}>Remember Me</span>
                        </div>
                        <div>
                            <a onClick={handleFormSwitch} className="text-sm text-gray-500">Forgot Password?</a>
                        </div>
                    </div>
                    <button
                        type="submit"
